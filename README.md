...
* To create a normal virtualenv (example _myvenv_) and activate it (see Code below).
  ...
  ```
  1. Create main project folder with name of your choice (eg. Todo List)
  ...
  4. TodoList-env\Scripts\activate    # Move into the virtual environment folder and activate the environment.
  
  5. cd ..   # move back into main project folder.
  
  6. cd TodoList    # Move into second (TodoList) folder.
